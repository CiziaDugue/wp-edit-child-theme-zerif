...
*/
		...
		/*Modification du footer pour intégrer les logos des partenaires*/
			//Test en dur
			/*$path1 = get_template_directory_uri() . '/images/';*/

			/*echo '<div class="col-md-6">';*/
			
			/*echo '<a href="http://www.caf.fr/"><img class="" src="logos/caf-loire.jpg" alt="CAF de la Loire"></a>';
			echo '<a href="https://www.loire.fr/jcms/j_4149/accueil"><img class="" src="'. get_template_directory_uri() .'/logos/departement-loire.jpg" alt="Département de la Loire"></a>';
			echo '<a href="https://ardechedromeloire.msa.fr/lfy"><img class="" src="'. get_template_directory_uri() .'/logos/msa.png" alt="MSA"></a>';
			echo '<a href="http://www.loire.gouv.fr/"><img class="" src="'. get_template_directory_uri() .'/logos/prefet-loire.jpg" alt="Préfet de la Loire"></a>';*/
			/*echo '</div>';*/
			
			//Test avec fonction d'appel de widget
			if ( is_active_sidebar( 'sidebar-aboutus' ) ) :

		$zerif_aboutus_clients_title_text = get_theme_mod( 'zerif_aboutus_clients_title_text' );

		echo '<div class="col-md-6 our-clients">';
